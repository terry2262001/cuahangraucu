                ...
                <div>
                    ...
                    <div class="sidebar">
                        ...
                        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                            ...
                            <div class="info">
                                <a class="d-block">Sửa Sản Phẩm</a>
                            </div>
                        </div>
                    </div>
                    <!-- /.sidebar -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../controller/UserController.php" method="post">
                        ...
                        <input type="text" placeholder="Tên khách hàng" id="tenkhachhang" class="margin-top20" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../PHP/customer_controller.php" method="post">
                        <input type="text" placeholder="Tên khách hàng" name="tenkhachhang" id="edit_tenkhachhang"
                            class="margin-top20" />
